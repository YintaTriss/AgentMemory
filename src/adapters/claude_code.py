...
class ClaudeCodeAdapter:
    ...
    def bind(self, mh: Any) -> Any:
        ...
        # Note: FastMCP only accepts name and version, not description
        self._mcp = FastMCP(name="AgentMemory")
    ...
    def _register_tools(self):
        ...
        @self._mcp.tool(
            name="memory_session_end",
            description="Mark session end and generate summary"
        )
    ...
    def export_tools(self, mh: Any = None) -> list:
        """
        导出工具列表
    ...
    def get_metadata(self) -> dict:
        ...
        return {
            ...
            "capabilities": {
                "tools": 6,
                "tool_names": ["memory_store", "memory_query", "memory_forget", "memory_stats", "memory_prefetch", "memory_session_end"],
